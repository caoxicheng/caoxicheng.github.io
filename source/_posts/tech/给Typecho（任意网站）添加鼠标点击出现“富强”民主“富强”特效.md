...
categories:
  - 技术
excerpt: >-
  为了中华民族之伟大复兴而努力奋斗！ <!--more--> 将代码放在主题的footer.php中的</body>之前即可。 <script
  type="text/javascript">  / 鼠标特效 / let aidx = 0; 
  jQuery(document).ready(functio...
description: 给Typecho（任意网站）添加鼠标点击出现“富强”民主“富强”特效 - 详细介绍与实践经验分享
keywords:
  - Typecho
  - 任意网站
  - 添加鼠标点击出现
