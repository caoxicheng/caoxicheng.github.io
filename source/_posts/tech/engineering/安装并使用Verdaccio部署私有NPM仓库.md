...
categories:
  ...
  - 工程化
excerpt: >-
  前言 需要搭建私有的NPM仓库，社区提供了两种方法，我们思考了一下，采用了Verdaccio「主要还是轻量吧」 --- 使用nodejs 安装 yum
  install -y gcc-c++ make curl -sL https://rpm.nodesource.com/setup14.x | su...
description: 安装并使用Verdaccio部署私有NPM仓库 - 详细介绍与实践经验分享
keywords:
  - 安装并使用
  - Verdaccio
  - 部署私有
