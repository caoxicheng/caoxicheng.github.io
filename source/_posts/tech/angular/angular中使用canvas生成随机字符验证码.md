...
categories:
  ...
  - Angular
excerpt: >-
  1. 没什么复杂的东西，旋转角度被我注释掉了，难度太大，酌情添加 2. 随机生成6位带字母的随机数请看另一篇文章 [post cid="393" /]
  <!--more--> HTML <canvas  (click)="getNewValidate()"></canvas> TS private ...
description: angular中使用canvas生成随机字符验证码 - 详细介绍与实践经验分享
keywords:
  - angular
  - 中使用
  - canvas
